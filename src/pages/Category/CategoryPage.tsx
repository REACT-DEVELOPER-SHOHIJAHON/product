...
const CategoryPage: React.FC = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-6">
      <h1 className={`text-5xl font-bold mb-6 capitalize text-black text-center`}>
      ...
      {isLoading ? (
        ...
        <div className="text-center text-red-500">
          {('message' in error) ? `Error: ${error.message}` : 'Error: An unknown error occurred'}
        </div>
      )}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        {displayedProducts && displayedProducts.length > 0 ? (
                ...
                <div className="p-4">
                  ...
                  <div className="flex justify-between items-center">
                    <button
                      ...
                      className="flex items-center bg-green-600 text-white px-3 py-1 rounded-full hover:bg-green-700 transition-colors"
                    >
                      <FaShoppingCart className="mr-1" /> ADD STORE
                    </button>
                    <button
          ...
          <div className="text-center text-gray-600 col-span-full">No products found in this category.</div>
        )}
      </div>
    </div>
  );
